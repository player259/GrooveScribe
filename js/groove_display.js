...
if (typeof(GrooveDisplay) === "undefined") {
	...
	(function () {
		...
		root.GrooveDBFormatPutGrooveInHTMLElement = function (HtmlTagId, GrooveDBTabIn) {
			...
			if(GrooveDBTabIn.tom3Tab !== undefined) myGrooveData.toms_array[2] = myGrooveUtils.noteArraysFromURLData("T3", GrooveDBTabIn.tom3Tab, GrooveDBTabIn.notesPerTabMeasure, GrooveDBTabIn.measures);
