...
function GrooveWriter() {
	...
	function hilight_individual_note(instrument, id) {
		...
		if (class_cur_tom2_highlight_id !== false && class_cur_tom2_highlight_id != id) {
			if (class_cur_tom2_highlight_id < class_notes_per_measure * class_number_of_measures)
				document.getElementById("tom2-" + class_cur_tom3_highlight_id).style.borderColor = "transparent";
	...
	root.closeMeasureButtonClick = function (measureNum) {
		...
		changeDivisionWithNotes(class_time_division, uiStickings, uiHH, uiTom1, uiTom2, uiTom3, uiTom4, uiSnare, uiKick);
	...
	function changeDivisionWithNotes(newDivision, Stickings, HH, Tom1, Tom2, Tom3, Tom4, Snare, Kick) {
		...
		if (Stickings && HH && Tom1 && Tom2 && Tom3 && Tom4 && Snare && Kick) {
	...
	root.changeDivision = function (newDivision) {
		...
		changeDivisionWithNotes(newDivision, uiStickings, uiHH, uiTom1, uiTom2, uiTom3, uiTom4, uiSnare, uiKick);
	...
	root.HTMLforStaffContainer = function (baseindex, indexStartForNotes) {
		...
		newHTML += ('\
							<span class="notes-row-container">\
								<div class="line-labels">\
									...
									<div style="display: none" class="tom-label" id="tom3-label" onClick="myGrooveWriter.noteLabelClick(event, \'tom3\', ' + baseindex + ')" oncontextmenu="event.preventDefault(); myGrooveWriter.noteLabelClick(event, \'tom3\', ' + baseindex + ')">T3</div>\
		...
		// Toms 3
		newHTML += ('\
										<div style="display: none" class="toms-container" id="tom3-container">\
											<div class="opening_note_space"> </div>');
		for (i = indexStartForNotes; i < class_notes_per_measure + indexStartForNotes; i++) {
			newHTML += ('\
